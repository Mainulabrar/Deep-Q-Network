...
def main():
     ...
     #save_session_name = '/data/data/Results/GPU1/sessionPYdrm10/'
   ...
   # ---------------------------------------------------------------------------
     with tf.device('/device:GPU:2'):
        ...
        if load_session == 1:
            ...
            DPTVex=pd.read_csv('/data/data/testdata/DVH_AI_IMRT_1_PTV_.csv',names=["Dose"])
            DBLAex=pd.read_csv('/data/data/testdata/DVH_AI_IMRT_1_Bladder.csv',names=["Dose"])
            DRECex=pd.read_csv('/data/data/testdata/DVH_AI_IMRT_1_Rectum.csv',names=["Dose"])
            flagg=0
