...
def evalu_training(mainDQN1: DQN, mainDQN2: DQN, mainDQN3: DQN, 
    ...
    for sampleid in range(1):
        ...
        X[:, 1] = x_bladder
        X[:, 2] = x_rectum
        data_result_path="/home/mainul1/DQN/Results/"
